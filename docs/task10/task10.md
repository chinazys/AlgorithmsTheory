Мої реалізації основних алгоритмів гешування, шифрування та цифрового підпису знаходяться у [цьому репозиторію](https://github.com/chinazys1001/distributed_lab_workshop).
